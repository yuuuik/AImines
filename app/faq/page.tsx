...
const faq = [
  ...
  { q: 'Как использовать промокод MARCHMINES?', a: 'Для реальных денег: при регистрации на 1win введите MARCHMINES в поле промокода — получите бонус до 500% на первый депозит. Для демо-баланса: раздел «Промокод» → введите MARCHMINES → нажмите «Применить».' },
  ...
  { q: 'Что делать если демо-баланс закончился?', a: 'Введите промокод MARCHMINES в разделе «Промокод» — баланс пополнится на 5 000 ₽. Либо перейдите в реальный режим, введя ID аккаунта 1win.' },
        ...
        <article className="max-w-2xl mx-auto px-6 py-10 text-white">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <a href={REAL_MONEY_URL} target="_blank" rel="noopener noreferrer" className="rounded-2xl border border-green-500/20 bg-green-500/5 p-4 hover:bg-green-500/10 transition-colors group">
              ...
              <p className="text-white/35 text-xs mt-0.5">1win · Промокод MARCHMINES</p>
            </a>
          </div>
