...
export const metadata: Metadata = {
  title: 'Mines APK скачать — установить на Android и iOS',
  description:
    'Установите Mines как приложение на телефон бесплатно без App Store и Google Play. Пошаговая инструкция для Android (Chrome) и iOS (Safari) — PWA установка за 10 секунд.',
  keywords: [
    'mines apk скачать',
    'mines установить android',
    'mines ios приложение',
    'mines pwa',
    'скачать mines бесплатно',
    'mines на телефон',
  ],
  alternates: {
  ...
  openGraph: {
    title: 'Mines APK скачать — установить на Android и iOS',
    description:
      'Установите Mines как приложение бесплатно без App Store. Инструкция для Android и iOS — за 10 секунд.',
    url: `${SITE_URL}/apk`,
    type: 'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Mines APK — установить на телефон' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Mines APK скачать — установить на Android и iOS',
    description: 'Установите Mines как PWA на Android и iOS бесплатно за 10 секунд.',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Установить приложение', item: `${SITE_URL}/apk` },
  ],
};
        ...
        <article className="max-w-lg mx-auto px-5 py-10 text-white">
          ...
          <header className="flex flex-col items-center text-center mb-10">
            <div className="relative mb-5">
              ...
              <div
                className="relative w-24 h-24 rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/15 border border-white/10"
                style={{ background: 'rgba(239,68,68,0.12)' }}
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/mines.png" alt="Mines" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
              </div>
            </div>
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-xs">
              Установите Mines как приложение для мгновенного доступа к AI подсказкам.
            </p>
          </header>
              ...
              >
                <div className="px-4 py-4 flex gap-3.5 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/40 text-xs leading-relaxed">
                      В Safari нажмите на центральную иконку со стрелкой вверх <span className="text-white/60 font-bold">↑</span> внизу экрана.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="px-4 py-4 flex gap-3.5 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/40 text-xs leading-relaxed">
                      Прокрутите список функций и нажмите <span className="text-white/65 font-semibold">«На экран Домой»</span>.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="px-6 py-6 flex flex-col items-center gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-white/35 text-sm mt-1">
                  Промокод <span className="text-blue-300 font-mono font-bold">MARCHMINES</span> — бонус до 500% на 1win
                </p>
              </div>
