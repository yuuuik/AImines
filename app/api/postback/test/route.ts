 ...
 * /api/postback/test?secret=mines2026
...
<head>
  ...
  <title>Постбэк тестер — Mines</title>
  <style>
...
<body>
  ...
  <p class="sub">Mines · только для вас</p>
  ...
  <div class="card">
    ...
    <p style="color:#4b5563;font-size:11px;margin-top:10px">Замените <code style="color:#f59e0b">{player_id}</code> на макрос из 1win</p>
  </div>
