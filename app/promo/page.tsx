...
export const metadata: Metadata = {
  title: 'Промокод MARCHMINES 1win — бонус 500% при регистрации',
  description:
    'Промокод MARCHMINES для 1win: бонус до 500% на первый депозит. Введите код при регистрации и получите максимальный приветственный бонус для игры Mines на 1win.',
  keywords: [
    'промокод 1win marchmines',
    'mines промокод',
  ...
  openGraph: {
    title: 'Промокод MARCHMINES 1win — бонус 500% при регистрации',
    description:
      'Введите MARCHMINES при регистрации на 1win и получите бонус до 500% на первый депозит для игры Mines.',
    url: `${SITE_URL}/promo`,
    type: 'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Промокод MARCHMINES 1win' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Промокод MARCHMINES 1win — бонус 500%',
    description: 'Введите MARCHMINES при регистрации на 1win — бонус до 500% на первый депозит.',
...
const faq = [
  {
    q: 'Что такое промокод MARCHMINES?',
    a: 'MARCHMINES — официальный партнёрский промокод для регистрации на платформе 1win. При использовании этого кода вы получаете увеличенный приветственный бонус до 500% на первый депозит.',
  },
  {
    q: 'Как использовать промокод MARCHMINES?',
    a: 'Перейдите на сайт 1win по кнопке «Зарегистрироваться на 1win» выше. При заполнении формы регистрации найдите поле «Промокод» и введите MARCHMINES. Бонус начисляется автоматически после первого пополнения.',
  },
  {
    q: 'Сколько можно получить с промокодом MARCHMINES?',
    a: 'Промокод MARCHMINES активирует бонус до 500% на первый депозит. Например, при пополнении на 5 000 ₽ ваш игровой баланс составит до 30 000 ₽. Точный размер зависит от суммы депозита и актуальных условий на сайте 1win.',
  },
  {
    q: 'Работает ли промокод MARCHMINES в 2025-2026 году?',
    a: 'Да, промокод MARCHMINES актуален и действует. Мы регулярно проверяем его работоспособность. Если при вводе возникает ошибка, убедитесь, что вводите заглавными буквами: MARCHMINES.',
  },
  {
    q: 'На какие игры распространяется бонус?',
    a: 'Бонус по промокоду MARCHMINES может быть использован на слоты, игры с минами и игры Mines на платформе 1win. Ознакомьтесь с полными условиями вейджера на сайте 1win.',
  },
  {
  ...
  },
  {
    ...
    a: 'Убедитесь что: (1) вводите код заглавными буквами — MARCHMINES, (2) вы создаёте новый аккаунт (промокод только для новых пользователей), (3) поле промокода заполнено до нажатия кнопки регистрации.',
  },
  {
    q: 'Как связана Mines с 1win?',
    a: 'Mines — демонстрационная версия игры в стиле 1win Casino. Демо-режим позволяет изучить механику и стратегии перед игрой на реальные деньги. Промокод MARCHMINES обеспечивает максимальный стартовый бонус при переходе на 1win.',
  },
  {
    q: 'Можно ли использовать промокод повторно?',
    a: 'Нет, промокод MARCHMINES применяется один раз — при первой регистрации. Бонус предназначен для новых игроков. Повторное использование на том же аккаунте невозможно.',
  },
  {
    q: 'Есть ли ограничения по странам?',
    a: 'Промокод MARCHMINES действителен для пользователей из стран, где платформа 1win ведёт деятельность. Уточните доступность в вашем регионе на официальном сайте 1win.',
  },
];
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Промокод MARCHMINES', item: `${SITE_URL}/promo` },
  ],
};
        ...
        <article className="max-w-lg mx-auto px-6 py-10 text-white">
          ...
          <div className="relative rounded-3xl overflow-hidden mb-10 shadow-2xl shadow-black/50">
            ...
            <div className="relative px-8 py-10 flex flex-col items-center gap-6 text-center">
              ...
              <p className="text-white/25 text-[11px] leading-relaxed">
                Введите MARCHMINES в поле промокода при регистрации.
          ...
          <section className="mb-10">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                { num: '02', title: 'Введите промокод', desc: 'При регистрации найдите поле «Промокод» и введите MARCHMINES заглавными буквами.' },
          ...
          <section className="mb-8">
            <h2 className="text-lg font-bold mb-5 flex items-center gap-2">
              <span className="w-1 h-5 rounded-full bg-gradient-to-b from-blue-400 to-green-400 inline-block" />
              Вопросы о промокоде MARCHMINES
            </h2>
            <div className="flex flex-col gap-3">
              {faq.map((item, i) => (
          ...
          <section className="mb-8">
            ...
            <div className="flex flex-col gap-3">
              {[
                { name: 'Дмитрий К.', date: '18 марта 2026', stars: 5, text: 'Не думал что так точно будет. Прошёл штук 30 раундов в демке, AI угадывал клетки процентов 70 от силы. Зарегался с промокодом MARCHMINES, дали бонус нормально. На реале уже несколько дней, пока в плюсе.' },
                { name: 'Алексей В.', date: '14 марта 2026', stars: 4, text: 'Удобно поиграть перед реальными деньгами и понять механику. Промокод сработал без вопросов. AI иногда ошибается но это нормально, в целом подсказки полезные. Советую начать с 1 миной.' },
                { name: 'Паша', date: '11 марта 2026', stars: 5, text: 'братишка, реально огонь. в демке понял систему, потом зашёл с MARCHMINES. позавчера взял иксы 15 при 5 минах и 10 клетках, вышел вовремя. теперь постоянно здесь сижу' },
                { name: 'Михаил Р.', date: '7 марта 2026', stars: 4, text: 'Играю по простой схеме. Открываю 3 клетки при 3 минах и выхожу. Стабильно небольшой плюс каждый день. Промокод дал хороший бонус для старта. Новичкам советую не жадничать.' },
              ].map((r, i) => (
