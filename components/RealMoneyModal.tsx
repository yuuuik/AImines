...
export default function RealMoneyModal() {
  ...
  const currentMult = useGameStore(s => s.currentMult);
  const revealedCount = useGameStore(s => s.revealedCount);

  const mult = revealedCount > 0 ? currentMult : 1.5;
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-black/70">
                ...
                <div className="relative px-7 py-8 flex flex-col items-center gap-5 text-center">
                  ...
                  <motion.div
                    ...
                    style={{ background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.3)', boxShadow: '0 0 32px rgba(239,68,68,0.2)' }}
                  >
                    💎
                  </motion.div>
                  ...
                  <div className="w-full rounded-2xl px-4 py-3.5 flex items-center gap-3 text-left" style={{ background: 'rgba(37,99,235,0.08)', border: '1px solid rgba(37,99,235,0.2)' }}>
                    ...
                    <div>
                      ...
                      <p className="font-mono font-bold text-base text-blue-300 tracking-widest leading-tight">MARCHMINES</p>
